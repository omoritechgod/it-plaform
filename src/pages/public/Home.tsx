...
import BtnBorder from "../../components/ui/BtnBorder";
  ...
  return (
    <div>
      ...
      >
          ...
          <div className="w-full h-full flex items-center pt-[5%] leading-10 justify-center flex-col gap-4">
            ...
            <ul className="flex gap-2 ">
              {["gain experience", "build projects", "get hired"].map(
                (item, index) => (
                  <li
                    key={index}
                    className="flex text-gray-300 items-center capitalize"
                  >
            ...
            <div className="flex gap-4 mt-4 justify-start">
              ...
              <Link to={ROUTES.ABOUT}>
                <BtnTransparent>Learn More</BtnTransparent>
              </Link>
            </div>
          </div>
          <div></div>
        ...
        <div className="w-full h-[120%] absolute bottom-0 left-0">
      ...
      <section className="md:max-w-5xl w-[95%] mx-auto py-16 border-t-2 border-gray-100 border-b-2">
        <div>
          <Title
          ...
          <div className="w-full mt-6 ">
            <motion.div
              ...
              viewport={{ once: true }}
              className="w-full h-full grid grid-col-1 md:grid-cols-2 gap-6"
            >
              {howItWorks.map((item, _index) => (
                <div
                  key={item.step}
                  className="min-w-[300px] shadow-none max-h-80"
                >
                  <div className="w-full h-full flex gap-4 justify-start items-start">
                    <span className="bg-black/40 rounded-[50%] p-1 px-2 text-white font-extrabold">
                      {item.step}
                    </span>
                    <div>
          ...
          <div className="w-full py-4 p-2 flex justify-start items-start mt-6 ">
            <Link to={ROUTES.APPLY}>
              <BtnBorder>Get Started Today</BtnBorder>
            </Link>
          </div>
        </div>
      </section>
      ...
      <section
        ref={ref}
        className="w-full min-h-64 h-full relative text-white radius my-12"
        style={{
      ...
      >
        <div className="w-full h-full radius bg-gradient-to-r from-[#0f266c85] via-[#0077C0] to-[#c7eeff75] mx-auto p-20">
          <div className="w-full h-full flex flex-col md:flex-row justify-center items-center gap-8 text-center">
            {stats.map((item, index) => (
              ...
              >
                ...
                <p className="font-bold capitalize text-white/60">
                  {item.title}
                </p>
                <p className="font-normal lowercase text-white/50">
                  {item.description}
                </p>
              </motion.div>
            ))}
      ...
      {/* Features Section */}
      <section className="md:max-w-5xl w-[95%] mx-auto py-16 border-t-2 border-gray-100">
        <Title
          title="Platform Benefit Overview?"
          description="Built to make internship management transparent, efficient, and
      ...
      <section className="md:max-w-5xl w-[95%] mx-auto py-16 border-t-2 border-gray-100 border-b-2">
        ...
        />
        <div className="flex flex-col-reverse gap-14 items-start justify-between mx-auto mt-6">
      ...
      <section className="my-12">
        <div className="max-w-7xl mx-auto">
          <div className="md:max-w-5xl w-[95%] mx-auto">
            <Title
