      ...
      <footer className="bg-white border-t border-gray-200 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-gray-600">Building the next generation of tech talent</p>
            <p className="text-sm text-gray-500 mt-2">© 2025 Internship Platform. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
